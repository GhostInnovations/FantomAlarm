...
!function(t, e) {
    ...
    function Rd(t) {
        var e, r = Md("svg", this.ownerSVGElement && this.ownerSVGElement.getAttribute("xmlns") || "https://www.w3.org/2000/svg"), i = this.parentNode, n = this.nextSibling, a = this.style.cssText;
        if (Re.appendChild(r),
        r.appendChild(this),
...
!function() {
    function s(t) {
        return t = t.replace(/\<script/gi, "<dscript").replace(/\<\/script/gi, "</dscript").replace(/javascript:/gi, "#").replace(/on[a-z]+=/gi, "don=")
    }
    function e(e) {
        var u, d, c, p = {
            up: [],
            ...
            var a, n, i, o, r, s, l = t.touches[0] || t.changedTouches[0];
            !l || !e && 1 < t.touches.length || (a = l.clientX - u,
            n = l.clientY - d,
            i = Math.abs(a),
            l = Math.abs(n),
            r = l < i ? (o = a < 0 ? "left" : "right",
            i) : (o = 0 < n ? "up" : "down",
            l),
            s = !1,
            p[o].forEach(function(t) {
                t.pd && t.pd() && (s = !0);
                var e = t.wp ? t.w * ("up" === o || "down" === o ? c.height : c.width) / 100 : t.w;
                r >= nt(t.m, 4, e || 40) && (0 < e ? (e = Math.floor(r / e)) !== t.l && (t.f(),
                t.l = e) : t.done || (t.done = !0,
                t.f()))
            }),
        ...
        e.addEventListener("touchstart", function(t) {
            1 === t.touches.length && (t = t.touches[0],
            u = t.clientX,
            d = t.clientY,
        ...
        e.addEventListener("touchforcechange", function(t) {
            var n = !1;
            w(p, function(t, e) {
                for (var a = 0; a < e.length; a++)
                    if (e[a].pd && e[a].pd()) {
        ...
        this.add = function(t, e, a, n, i) {
            var o;
            "string" == typeof e && 0 <= e.indexOf("%") && (e = I(e, 100),
            o = !0),
            p[t].push({
                w: e,
                wp: o,
        ...
        this.remove = function(t, e) {
            for (var a = 0; a < p[t].length; a++)
                if (p[t][a].f === e)
                    return void p[t].splice(a, 1)
        }
    }
    function u(t) {
        return t._pg_gh || (t._pg_gh = new e(t)),
        t._pg_gh
    }
    var d = !1;
    ...
    gsap.registerPlugin({
        ...
        render: function(t, e) {
            e.cl && (0 === t ? (e.t.getAttribute("class") !== e.o && e.t.setAttribute("class", e.o),
            e.has = !1) : 0 < t && (e.v.add && (e.cl.contains(e.v.add) || e.cl.add(e.v.add)),
            e.v.set && e.t.getAttribute("class") !== e.v.set && e.t.setAttribute("class", e.v.set),
            e.v.remove && e.cl.contains(e.v.remove) && e.cl.remove(e.v.remove),
            e.v.toggle && !e.has && (e.cl.toggle(e.v.toggle),
            e.has = !0)))
        }
    });
    var t = {
        ...
        init: function(t, e, a, n, i) {
            if (lottie) {
                var o = null;
                if (e.anim)
                    o = C(e.anim, t, e.target_element);
                else if (t._pg_lottie)
                    o = t._pg_lottie;
                else
                    for (var r = lottie.getRegisteredAnimations(), s = 0; s < r.length; s++)
                        if (r[s].wrapper === t) {
                            o = r[s],
                            t._pg_lottie = o;
                            break
                        }
                o && "object" == typeof o && "goToAndStop"in o ? (this.t = t,
                this.v = e,
                this.a = o,
                this.tw = a,
                ...
                this.doing = !1,
                this.gf = function(t) {
                    return 0 <= (t += "").indexOf("f") ? at(t.replace("f", ""), 0) : F(null, t) * o.frameRate
                }
                ) : q("Lottie animation is not specified. Add transform on animated element or use Animation property.")
            } else
                q("Lottie is not defined. Include it before pgia.js.")
        },
        render: function(t, e) {
            e.a && (e.v.seek && e.a.goToAndStop(t * e.dur * 1e3, !1),
            0 < t && !e.doing ? ("play"in e.v && ("" === e.v.play ? e.a.play() : e.a.goToAndPlay(e.gf(e.v.play), !0)),
            "pause"in e.v && ("" === e.v.pause ? e.a.pause() : e.a.goToAndStop(e.gf(e.v.pause), !0)),
            e.v.toggle && (e.a.isPaused ? e.a.play() : e.a.pause()),
            e.doing = !0) : 0 === t && (e.doing = !1))
        }
    };
    ...
    t = {
        ...
        init: function(a, t, e, n, i) {
            ...
            this.dur = e.duration(),
            this.c = function(t, e) {
                return "string" == typeof t && (t = window[t]),
                t(a, e),
                t
            }
        },
    ...
    var l = 0
      ...
      , p = {
        ...
        init: function(t, e, a, n, i) {
            ...
            this.append = !0,
            this.live = !1,
            this.target_element = "function" == typeof e.target_element ? e.target_element(t) : e.target_element || null,
            e.clone) {
                var o = (new Date).getTime();
                if (t._pg_clone_time && o - t._pg_clone_time < 200)
                    return void q("This element was just cloned and is now cloning others. Probably a recursive loop!");
                o = t.cloneNode(!0);
            ...
            o = at(e.count || 1);
            "string" == typeof e.count_sel && (o = V(t, e.count_sel).length + at(e.count || 0)),
            this.count = o
        },
        _d: function(t) {
            t && (X.elementAnimationsManager.destroyAnimations(t, !0),
            X.scrollSceneManager && X.scrollSceneManager.removeScene(t, !0),
            t.parentNode && t.parentNode.removeChild(t))
        },
        _c: function(t) {
            t && (X.elementAnimationsManager.refreshAnimations(t, !0),
        ...
        render: function(t, e) {
            if (e.template) {
                ...
                if (0 <= i && i < e.created.length)
                    for (; e.created.length > i; )
                        p._d(e.created.pop());
                for (; 0 < i && i > e.created.length; ) {
                    if (100 < ++c)
                        return void q("Cloning too many elements is a sign of an endless loop. Blocking. Tried to clone " + c + " elements.");
                    if (!(n = e.live ? e.t.cloneNode(!0) : ((o = document.createRange()).selectNodeContents(e.t),
                    o.createContextualFragment(e.live ? e.t.outerHTML : e.template).firstChild)))
                        break;
                    n.removeAttribute("data-pg-id");
                    var o = (e.created.length ? e.created[e.created.length - 1] : e.t).nextSibling;
                    e.append || !o ? e.t.parentNode.appendChild(n) : e.t.parentNode.insertBefore(n, o),
                    n.classList ? n.classList.add("pgia-clone") : n.className += " pgia-clone",
                    e.created.push(n);
                    var r = !1
                      , o = s(M(n.innerHTML, function(t) {
                        return r = !0,
                        (e.target_element || n).getAttribute(t) || ""
                    }));
                    r && (n.innerHTML = o),
                    e.v.pos && (n._pg_position = new h(n,e.target_element,C(e.v.pos, n, e.target_element) || "auto",at(e.v.pos_dist || 0),at(e.v.pos_width || 0),at(e.v.pos_height || 0),e.v.pos_scale || !1,e.v.pos_no_repo || !1),
            ...
            e.v.remove && (1 != t || e.removed ? t < 1 && e.removed && (e.parent && (e.next ? e.parent.insertBefore(e.t, e.next) : e.parent.appendChild(e.t)),
            e.removed = !1,
            p._c(e.t)) : (p._d(e.t),
            e.removed = !0)),
            e.v.reparent && (a = e.parent != e.t.parentNode,
            0 == t && a ? e.parent.appendChild(e.t) : 0 < t && !a && ((a = V(e.t, e.v.reparent)[0]) && a.appendChild(e.t)))
        }
    };
    ...
    var a = new function() {
      ...
      , h = function(d, c, t, p, h, f, g, e) {
        ...
        this.parent = this.fixed ? d.ownerDocument.body : function(t) {
            var e = t.parentNode;
            for (; e && 1 == e.nodeType; ) {
        ...
        this.update = function() {
            if (!d.ownerDocument || !c.ownerDocument || !d.parentNode)
                return d._pg_position = null,
                this.destroy(),
                !1;
            var t, e, a = window.innerWidth, n = window.innerHeight, i = d.getBoundingClientRect(), o = c.getBoundingClientRect(), r = this.parent.getBoundingClientRect(), s = h ? o.width * h / 100 : i.width, l = f ? o.height * f / 100 : i.height;
            g && h && !f && (l *= s / i.width),
            g && f && !h && (s *= l / i.height);
        ...
        this.move = function(t) {
            ...
            h && (t = this.ow + (this.w - this.ow) * e,
            g ? (a.scaleX = t / d.offsetWidth,
            f || (a.scaleY = a.scaleX)) : a.width = t),
            f && (e = this.oh + (this.h - this.oh) * e,
            g ? (a.scaleY = e / d.offsetHeight,
            h || (a.scaleX = a.scaleY)) : a.height = e),
            n(a)
        }
        ,
      ...
      , t = {
        ...
        init: function(t, e, a, n, i) {
            ...
            this.v = e,
            this.added = !1;
            var o = "function" == typeof e.target_element ? e.target_element(t) : e.target_element || null;
            e.tsel && (o = V(t, e.tsel)[0] || o),
            this.norepos = C(e.no_repo || "0", t, o),
            this.pos = new h(t,o,C(e.pos || "auto", t, o),C(e.dist || "0", t, o),C(e.width || "0", t, o),C(e.height || "0", t, o),C(e.scale || "0", t, o),!0)
        },
        render: function(t, e) {
            0 === t ? (a.remove(e.pos),
            e.added = !1) : e.norepos || e.added || (e.pos.update(),
            a.add(e.pos),
            e.added = !0),
            e.pos.move(t)
        }
    ...
    t = {
        ...
        init: function(t, e, a, n, i) {
            if (this.t = t,
            this.v = e,
            this.te = "function" == typeof e.target_element ? e.target_element(t) : e.target_element || null,
            this.pr = 0,
            this.dir = e.dir || "f_b",
        ...
        render: function(e, a) {
            var t = a.pr <= e ? "f" : "b";
            0 <= a.dir.indexOf(t) && (0 < e && ("rec"in a.v && !a.recreated && ($(a.pt, function(t) {
                X.recreate(t, C(a.v.rec || a.v.play || "", a.t, a.te))
            }),
            a.recreated = !0),
            a.v.play && (!a.v.cont && a.played || $(a.pt, function(t) {
                X.play(t, C(a.v.play, a.t, a.te), null, !!a.v.cont)
            }),
            a.played = !0),
            a.v.pause && !a.paused && ($(a.pt, function(t) {
                X.pause(t, C(a.v.pause, a.t, a.te))
            }),
            a.paused = !0)),
            a.v.seek && $(a.pt, function(t) {
                X.seek(t, C(a.v.seek, a.t, a.te), e, !1)
            })),
            0 !== e && 1 !== e || a.v.once || (a.played = a.paused = a.recreated = !1),
            a.pr = e
        }
    },
    gsap.registerPlugin(t),
    ...
    function i() {
        return R ? n.hasAttribute("data-pg-mobile") : "string" == typeof pgia_small_mq ? !!window.matchMedia && window.matchMedia(pgia_small_mq).matches : screen.width < 1e3 && screen.height < 1e3
    }
    ...
    var Y, U, N, z, H, Z, F, j, W, J, w, A, f, V, g, $, Q, G, o, r, K, tt, et, m, v, _, y, x, b, k, O, T, t = !0;
    function E(t, e) {
        for (var a = e + "Sibling", n = t[a]; n && 1 !== n.nodeType; )
            n = n[a];
        return n
    }
    function at(t, e) {
    ...
    function L(t) {
        return !t.paused() && 0 < t.duration() && (t.reversed() ? 0 < t.progress() : t.progress() < 1)
    }
    function P(t) {
    ...
    function C(t, a, n, e) {
        t = M(t, function(t) {
            var e = t.split("|");
            return (void 0 === (t = it(t = e[0], "--") ? (window.getComputedStyle(a).getPropertyValue(t) || "").trim() : function(t, e, a, n) {
                var i = window
                  , o = t.split(".")
                  , t = 0;
                "this" == o[0] ? (i = e,
                ...
                for (var r = t; r < o.length; r++) {
                    ...
                    if (i instanceof HTMLElement) {
                        ...
                        if ("style" == l && r < o.length - 1)
                            return null === (i = window.getComputedStyle(i).getPropertyValue(o[r + 1])) ? n : i
                    }
    ...
    function rt(t, e, a) {
        ...
        if (!a)
            for (var d, c = e ? V(t, e) : t.children, p = 0; p < c.length; p++)
                (c[p].getAttribute("class") || "").indexOf("gsap-marker") < 0 && (d = c[p],
                r = u.p,
                s = u.spleft,
                l = u.sptop,
                d = {
    ...
    function st(t) {
        ...
        return scene = t == window ? e(document.body) || e(document.documentElement) : e(t),
        scene && scene.st
    }
    function lt(e, a, n) {
        if (e[a])
            try {
                ...
                "play" === a ? e[a]().then(function() {
                    e._pgia_broken = !1
                }).catch(function(t) {
                    e._pgia_broken = !0,
                    "play" !== a || "AUDIO" == e.nodeName || e.muted || (e.muted = !0,
                    lt(e, a, n)),
                    q(t)
                }) : e[a]()
            } catch (t) {
    ...
    function ut(t, e) {
        if (e) {
            ...
            case "next":
                var o = "next" === n[1];
                if (!i)
                    return [E(a[0], e) || ((s = (s = a[0].parentNode)[(l = o ? "first" : "last") + "Child"]) ? 1 === s.nodeType ? s : E(s, "first" === l ? "next" : "previous") : null)];
                for (var r = 0; r < a.length; r++)
                    if (a[r].matches(i))
                        return [o ? r + 1 < a.length ? a[r + 1] : a[0] : 0 < r ? a[r - 1] : a[a.length - 1]];
    ...
    function dt(t, a) {
        ((t || "") + "").split(/\s*,\s*/).forEach(function(t) {
            ...
            var e = !1;
            "string" == typeof t ? it(t, "-") && (e = !0,
            t = t.substr(1)) : t < 0 && (e = !0,
            t = -t),
            a(t, e)
        })
    }
    ...
    screen && Element.prototype.matches && void 0 !== Array.isArray && "innerHeight"in window && !n.hasAttribute("data-pg-ia-disabled") && document.createElement("div").classList || (t = !1),
    ...
    H = function(t, e, a, n, i, o, r, s, l, u, d, c) {
        ...
        if (g) {
            ...
            if (void 0 !== l && (_ = l),
            s && (!n && N(_, 1) || n && N(_, 0)) && (_ = n ? 1 : t.c[0][p] / m,
            e = o ? document.documentElement : e,
            b = _ * m,
            o ? window.scrollTo(a ? b : t.sptop, a ? t.spleft : b) : e["scroll" + f] = b),
            void 0 !== d)
                return u ? {
                    px: t.p[h] * d,
                    p: t.p[h] * d / m,
            ...
            O = -1;
            var y, w, A, x, b = (r ? r.pgBottomCover : 0) / m, s = (r ? r.pgTopCover : 0) / m;
            if ("c" === n || i) {
                for (var k = _ + t.p[h] / m - b, O = 0, T = 0, E = d = 0, S = (r ? r.pgTopCover : 0) / m, M = 0; M < g; M++) {
                    var L = (t.c[M][p] - v) / m
            ...
            if (u)
                T = !n && 1 == _ && c ? (O = s * m) / m : (O = nt(_ * m + t.p[h] * (n ? -1 : 1), 0, m)) / m;
            else if (n) {
                _ += s;
                for (M = g - 1; 0 <= M; M--) {
                    var B = Y(t.c[M][p]);
                ...
                for (M = 0; M < g; M++) {
                    B = Y(t.c[M][p]);
                    if (!N(y = T = (B - v) / m, w = _) && w < y || i && N(T, _)) {
                        O = B,
                        d = M;
                        break
                    }
    ...
    X.getTargets = V,
    g = function(t) {
        return "forEach"in t || t instanceof NodeList || t instanceof HTMLCollection || Array.isArray(t) ? t : [t]
    }
    ,
    $ = function(t, e) {
    ...
    ,
    G = function(t, e, a) {
        return !(e in t) || "" === t[e] ? a : void 0 === a || "number" != typeof a || isNaN(t[e]) ? t[e] : at(t[e])
    }
    ,
    o = 0,
    r = function() {
        this.getTimeline = function(t, f, e, g) {
            ...
            var y = gsap.timeline({
              ...
              , m = "_pgia_target_" + o++;
            return t && t.l && t.l.forEach(function(e) {
                e.m || e.l.sort(function(t, e) {
                    return t.p === e.p ? "flip" === t.t ? -1 : "flip" === e.t ? 1 : "set" === t.t ? -1 : "set" === e.t ? 1 : 0 : t.p - e.p
                }).forEach(function(a) {
                    ...
                    r = [],
                    $(f, function(e) {
                        Array.prototype.forEach.call(V(e, C(i, e, e)), function(t) {
                    ...
                    p = {
                        "media.playing": function(t, e) {
                            function a() {
                                n.forEach(function(t) {
                                    t.paused && !t._pgia_broken && ("" !== e || isNaN(t.duration) || t.duration > t.currentTime) && lt(t, "play", e)
                                })
                            }
                            u.push(a),
                            c.push(a),
                        ...
                        scrollTo: function(t, d) {
                            ...
                            y._pg_req_inv = !0;
                            function e(t, e) {
                                var a, n = _(e), i = C(h, e, n), o = !1;
                                0 <= (i + "").indexOf("_or_start") && (o = !0,
                                i = i.replace("_or_start", ""));
                                var r, s = st(e);
                                function l() {
                                    return e["client" + ("y" == p ? "Height" : "Width")]
                                }
                                switch (s ? (f = s.pgInf,
                                p = s.pgHor ? "x" : "y") : d.dir || (p = "h" == U(e) ? "x" : "y"),
                                i) {
                                case "next":
                                case "prev":
                                    a = H(null, e, "x" == p, "prev" == i, !1, g, s, f, void 0, !1, void 0, o),
                                    c[p] = a.px;
                                    break;
                                case "first":
                                    a = H(null, e, "x" == p, !1, !1, g, s, f, void 0, !1, 0),
                                    c[p] = a.px;
                                    break;
                                case "last":
                                    a = H(null, e, "x" == p, !1, !1, g, s, f, void 0, !1, 9999),
                                    c[p] = a.px;
                                    break;
                                case "next_page":
                                case "prev_page":
                                    a = H(null, e, "x" == p, it(i, "prev"), !1, g, s, f, void 0, !0, void 0, o),
                                    c[p] = a.px;
                                    break;
                                default:
                                    if ("string" != typeof i)
                                        ...
                                        function u() {
                                            var t = P(n);
                                            return 4 < i.length ? t = at(i.substr(4)) : n.hasAttribute("data-item-idx") && (t = at(n.getAttribute("data-item-idx"))),
                                            t
                                        }
                                        if (it(i, "item")) {
                                            r = u(),
                                            a = H(null, e, "x" == p, !1, !1, g, s, f, void 0, !1, r),
                                            c[p] = a.px;
                                            break
                                        }
                                        if (it(i, "page")) {
                                            r = u(),
                                            a = H(null, e, "x" == p, !1, !1, g, s, f, void 0, !0, r),
                                            c[p] = a.px;
                                            break
                                        }
                                        c[p] = I(i, l)
                                ...
                                return c["offset" + p.toUpperCase()] = "st" === m ? s ? s.pgTopCover : 0 : C(m, e, n, l),
                                c
                            }
                            !n.length || "BODY" != n[0].tagName && "HTML" != n[0].tagName ? v.scrollTo = e : (t = {
                                scrollTo: e(0, n[0])
                            },
                            a.e && (t.ease = A(a.e)),
                        ...
                        "history.push": function(t, e) {
                            u.push(function() {
                                n.forEach(function(t) {
                                    (e = C(e, t, _(t))) && history.pushState({}, "", e)
                                })
                            })
                        },
                        attr: function(t, e) {
                    ...
                    h = function(t) {
                        ...
                        return "object" == typeof t && null !== t && (t.target_element = _),
                        t
                    }
                    ,
                    p["stroke-dasharray"] = p["stroke-dashoffset"] = function(t, n) {
                        n = h(n),
                        v[t] = function(t, e, a) {
                            return "function" == typeof n && (n = n(t, e, a)),
                            I(n, function() {
                    ...
                    a.e && (v.ease = A(a.e)),
                    c.length && (v.onUpdate = function(e) {
                    ...
                    u.length && (v.onStart = function() {
                        u.forEach(function(t) {
                            t()
                        })
                    }
                    ),
                    d.length && (v.onComplete = function() {
                        d.forEach(function(t) {
                            t()
                        })
                    }
                    ),
                    n.length && ("flip" === a.t || (0 === l ? y.set(n, v, s) : a.s && !g ? y.staggerTo(n, l, v, a.s, s) : y.add(TweenLite.to(n, l, v), s))))
                })
            }),
            y
        }
    ...
    ,
    tt = X.getAnimationTimeline = function(t, e, a) {
        if ("string" == typeof t && X.namedAnimations[t] && (t = X.namedAnimations[t]),
        "string" != typeof t)
            return (new r).getTimeline(t || {}, e, null, a);
        e = X.animationPresets.getTimeline(t, e);
        return e || (q("Named animation not found: " + t),
        e = gsap.timeline({})),
        e
    }
    ,
    ...
    (m = function(t, e, a, n) {
        ...
        this.disabled = j(a),
        this.interval = null,
        this.softDelay = "soft"in a ? F(null, a.soft) : .5,
        ...
        var o = !1
          , r = !0
          , s = !0;
        0 < this.event.indexOf("_notouch") && (this.event = this.event.replace("_notouch", ""),
        r = !1),
        it(this.event, "swipe") && (this.swipe = {
        ...
        function l() {
            ...
            case "resize":
            case "popstate":
                window.addEventListener(i.event, i._playBind, !1),
                o = !0;
                break;
            case "timer":
                i.interval = setInterval(i._playBind, 1e3 * F(null, a.timer || 1)),
                o = !0;
                break;
            case "mousemove":
            case "touchmove":
                "run" === i.mouseMoveMeasure ? i.touchEvent = "touchmove" : (t.addEventListener(i.event, i._playMouseMoveBind, !1),
                t.addEventListener("touchmove", i._playMouseMoveBind, !!a.pdef && {
                    passive: !1
                }),
                i.data.mm_r && (t.addEventListener("mouseleave", i._restBind, !1),
            ...
            o || (t.addEventListener(i.event.replace("res_", ""), i._playBind, !(!it(i.event, "touch") || !a.pdef) && {
                passive: !1
            }),
            i.touchEvent && t.addEventListener(i.touchEvent, i._playBind, !("touchmove" !== i.touchEvent || !a.pdef) && {
                passive: !1
            }))
        }
        e = W(a);
        e ? (n = D.contexts.length,
        i.inactive_mq = !0,
        D.add(e, function(t) {
            return l(),
            i.inactive_mq = !1,
        ...
        this.mm_context = D.contexts[n]) : l()
    }
    ...
    m.prototype.create = function() {
        ...
        (t = this.targets.length ? (n = this.targets,
        this._etce = n[0],
        tt(a.a, n, this.redm)) : gsap.timeline({})).pause();
        var n = parseInt(a.rpt || 1);
        return 1 !== n && t.repeat(1 < n ? n - 1 : n),
        this.data.d && t.duration(F(t, a.d)),
        this.redm && .01 < t.duration() && t.duration(.01),
        this.timeline = t,
        R && (t._pg_animation_id = Z.getAnimationId(this.element, "animation_" + this.index),
        t.eventCallback("onUpdate", function() {
            Z.updateProgress(this._pg_animation_id, this.time(), this.progress())
        })),
    ...
    m.prototype.play = function(t, e) {
        ...
        j(this.data) || (this.data.rcr && this.recreate(),
        a = this.getTimeline(),
        this._etc() && (t && it(t.type, "key") && this.keys.indexOf(" " == t.key ? "Spacebar" : t.key) < 0 || (s.data.pdef && t && t.preventDefault(),
        s.data.sprop && t && t.stopPropagation(),
        n = this.reverse || e,
        s.toggRev && (s.trigC++ % 2 == 1 && (n = !n),
        i = n ? G(s.data, "spdrev", 100) / 100 : 1,
        s.data.d ? a.duration(F(a, s.data.d) / i) : a.timeScale(i),
        s.redm && .01 < a.duration() && a.duration(.01)),
        i = n ? a.duration() : 0,
        o = (a._pg_req_inv || this.restart) && !s.data.noinv,
        r = !this.restart && (n ? 0 < a.progress() : a.progress() < 1) ? null : 0,
        this.delayTimer && clearTimeout(this.delayTimer),
        this.pauseOther && (s = G(s.data, "pol", ""),
        this.parent.pauseOther(this, s ? s.split(/\s?,\s?/) : []),
        o = !0),
        a.time() !== i && r !== i || !this.data.dly ? (o && a.invalidate(),
        n ? a.reverse(r) : a.play(r)) : this.delayTimer = setTimeout(function() {
            o && a.invalidate(),
            n ? a.reverse(r) : a.play(r)
    ...
    m.prototype.playMouseMove = function(t) {
        if (!j(this.data)) {
            ...
            if (this._etc()) {
                ...
                var a, n = this.element.getBoundingClientRect(), i = it(t.type, "touch") ? (a = t.targetTouches[0].pageX,
                t.targetTouches[0].pageY) : (a = t.pageX,
                t.pageY), o = 0, r = window.pageXOffset, s = window.pageYOffset;
    ...
    m.prototype.playScrub = function(t) {
        var e, a, n;
        j(this.data) || (e = this.getTimeline(),
        this._etc() && (this.data.pdef && t.preventDefault(),
        this.data.sprop && t.stopPropagation(),
        n = at((a = t.target).value, 0),
        t = 0,
        t = "checkbox" == a.type ? a.checked ? 1 : 0 : (nt(n, this.smin, this.smax) - this.smin) / (this.smax - this.smin),
    ...
    m.prototype.playScroll = function(t) {
        var e, a;
        j(this.data) || (e = this.getTimeline(),
        this._etc() && (a = nt(window.pageYOffset / (document.body.offsetHeight - window.innerHeight), 0, 1),
        this.softSeek(e.duration() * a, this.softDelay)))
    }
    ,
    m.prototype.seek = function(t, e, a) {
        var n;
        j(this.data) || (n = this.getTimeline(),
        t = Math.max(0, F(n, t)),
        e && 1 === n.progress() && (t = 0),
        this.delayTimer && clearTimeout(this.delayTimer),
    ...
    m.prototype.softSeek = function(t, e) {
        ...
        a.paused() || a.pause(),
        0 === e ? a.seek(t) : a._pg_seek_tween = TweenMax.to(a, e, {
            time: t
        })
    }
    ,
    ...
    m.prototype.refresh = function(t) {
        ...
        var e = this.timeline
          , t = 0;
        e && (e._pg_seek_tween && e._pg_seek_tween.kill(),
        t = e.time(),
        e.seek(0),
        e.kill()),
        this.create(),
    ...
    m.prototype.destroy = function(t) {
        ...
        case "mousemove":
        case "touchmove":
            "run" === this.mouseMoveMeasure ? this.element.removeEventListener(this.event, this._playBind) : (this.element.removeEventListener(this.event, this._playMouseMoveBind),
            this.element.removeEventListener("touchmove", this._playMouseMoveBind),
            this.data.mm_r && (this.element.removeEventListener("mouseleave", this._restBind),
        ...
        this.touchEvent && this.element.removeEventListener(this.touchEvent, this._playBind),
        this.delayTimer && clearTimeout(this.delayTimer),
        this.interval && clearInterval(this.interval),
        this.timeline && !t && (this.timeline.pause(0),
        this.timeline._pg_seek_tween && this.timeline._pg_seek_tween.kill()),
        this.timeline = null,
        this.mm_context && !t && (this.mm_context.kill(!0, D),
        this.mm_context = null)
    }
    ,
    (v = function(t, e, a) {
        ...
        e && e.l) {
            ...
            for (n = 0; n < e.l.length; n++)
                "string" == typeof e.l[n].a && this.named[e.l[n].a] && (this.named[e.l[n].a].u.push(n),
    ...
    v.prototype.refresh = function(n, t, e) {
        var a = t.l[n];
        if (a.name && K(a.name, a.a),
        !e && a.name && "object" == typeof a.a) {
            this.named[a.name] || (this.named[a.name] = {
                u: []
            }),
        ...
        "string" == typeof a.a && this.named[a.a] && (this.named[a.a].u.push(n),
        a.a = this.named[a.a].a);
        e = this.find(n);
        e && e.refresh(a)
    }
    ,
    ...
    v.prototype.pauseOther = function(e, a) {
        ...
        this.animations.forEach(function(t) {
            (t !== e && (!a.length || 0 <= a.indexOf(n + "")) || t.name && 0 <= a.indexOf(t.name)) && t.pause(),
            n++
        })
    }
    ,
    ...
    X.play = function(n, t, e, i) {
        ...
        n._pg_animations && dt(t, function(t, e) {
            var a = n._pg_animations.find(t, !0);
            !a && X.namedAnimations[t] && (t = {
                name: t,
                trg: "no",
                a: X.namedAnimations[t]
            },
            a = new m(n,n._pg_animations.animations.length,t,n._pg_animations),
    ...
    X.pause = function(a, t, n) {
        a._pg_animations && dt(t, function(t, e) {
    ...
    ,
    _ = "data-pg-ia-apply",
    y = ["data-pg-ia", "data-pg-ia-scene", "data-pg-ia-hide", "data-pg-ia-show", "data-pg-ia-smooth-scroll"],
    x = function(a) {
        ...
        if (t && "this" !== t)
            try {
                ...
                y.forEach(function(t) {
                    var e;
                    a.hasAttribute(t) && (e = a.getAttribute(t) || "",
                    n.push({
                        a: t,
                        v: e,
                        d: B(e)
                ...
                $(V(a, t), function(e) {
                    a != e && n.forEach(function(t) {
                        e.hasAttribute(t.a) ? "data-pg-ia" == t.a && ot(e, t.a, t) : e.setAttribute(t.a, t.v)
                    })
                })
            } catch (t) {
                q(t)
    ...
    X.applyToMany = function(t) {
        t.hasAttribute(_) && x(t),
        $(t.querySelectorAll("[" + _ + "]"), x)
    }
    ,
    b = [],
    ...
    X.add = function(e, t, i) {
        ...
        $(t, function(t) {
            $(V(t, e), function(t) {
                    ...
                    if (i.hasOwnProperty(e)) {
                        ...
                        if ("interactions" === e) {
                            ...
                            if (n) {
                                ot(t, a, o[e], n),
                                r && k.push(function() {
                                    ot(window._pg_animation_phone.getPgel(t), a, o[e], n)
                                });
                                continue
                            }
                        } else
                ...
                b.push(function() {
                    i.interactions && X.elementAnimationsManager.refreshAnimations(t),
                    i.scene && X.scrollSceneManager.createScene(t),
                    i["smooth-scroll"] && X.smoothScrollManager && X.smoothScrollManager.create(t)
                })
            })
        })
    }
    ...
    X.elementAnimationsManager = new function() {
        ...
        this.refreshCustomAnimation = function(t, e) {
            var a;
            t._pg_animations && (a = JSON.parse(S(t.getAttribute("data-pg-ia"))),
            t._pg_animations.refresh(e, a))
        }
        ,
        this.refreshAnimations = function(t, e) {
            a.destroyAnimations(t),
            r(t),
            e && o(t, a.refreshAnimations)
        }
        ,
    ...
    O = function(P, t) {
        var C, I, B, Y = this, N = [], s = -1, n = !1, i = null;
        this.destroy = function() {
            n || (I && (I._pg_seek_tween && I._pg_seek_tween.kill(),
            I.pause(0),
            I.kill()),
            B && B.kill(),
            N.forEach(function(t) {
        ...
        this.create = function() {
            ...
            (n = j(e)) || ((t = W(e)) ? (a = D.contexts.length,
            D.add(t, function(t) {
                return Y.createInner(e, !0),
                function() {
                    N = [],
                    C = null
                }
            }),
            i = D.contexts[a]) : Y.createInner(e))
        }
        ,
        this.createInner = function(n, e) {
            ...
            var a, i, o = P, r = null;
            "auto" === n.s ? (a = "start end",
            i = "start start") : "custom" === n.s ? (a = n.s_t || "top",
            a += " " + (n.s_s || "top"),
            n.s_o && (a += t(n.s_o)),
            i = n.e_t || "",
            i = (i += " " + (n.e_s || "")).trim(),
            n.e_o && (i += t(n.e_o)),
            n.s_scroller && (r = V(P, n.s_scroller)[0])) : "whole" === n.s ? (r = P,
            o = null,
            a = 0) : (a = {
                onEnter: {
                    s: "start end",
            ...
            i = "+=" + (n.d || "200%"),
            n.o && (u = it(u = n.o + "", "-") ? u.substr(1) : "-" + u,
            a += t(u))),
            r || (!(c = o.parentNode) || (d = st(c)) && (r = d.scroller)),
            r !== document.body && r !== document.documentElement || (r = null);
            t = F(null, n.smooth, .5);
            0 === t ? t = !0 : void 0 === t && (t = .5),
            "a" === n.dir && (n.dir = U(r));
            var s = "h" === n.dir
              , u = function(t) {
                return "string" == typeof t && (t = s ? t.replace(/start/g, "left").replace(/end/g, "right") : t.replace(/start/g, "top").replace(/end/g, "bottom")),
                t
            };
            a = u(a),
            i = u(i);
            var d, c = !1;
            (n.snap || "").length && (c = "e" === n.snap ? {
                snapTo: function(t, e) {
                    return 1 == e.progress ? 1 : H(null, e.scroller, s, T < 0, !0, n.snap_sel || null, e, !1).p - e.pgTopCover / (e.end - e.start)
                }
            } : {
            ...
            l && (c.duration = .01)),
            (d = F(null, n.snap_del || (!0 !== t ? t + .1 : .3))) && (c.delay = d),
            !0 !== t && d < t && (q("Scroll scene smoothing delay " + t + " should not be longer than snap delay " + d + "! Adjusting..."),
            c.delay = t + .1),
            n.snap_ease && (c.ease = n.snap_ease));
            var p, h, f, g, m, v, _, y, w, A, x, b, k, O, T = 0, t = {
                trigger: o,
                start: function() {
                    return a
                },
                ...
                scrub: t,
                horizontal: s,
                markers: !!n.dbg && (R || P.hasAttribute("data-pgia-show-markers")),
                snap: c,
            ...
            r && (t.scroller = r),
            t.pin && (n.pin_type && (t.pinType = n.pin_type),
            n.pin_body && (t.pinReparent = !0),
            "auto" == (c = n.pin_spc || "auto") ? "flex" != (r = window.getComputedStyle(t.pin.parentNode)).display && "absolute" != r.position || (c = "margin") : "false" == c && (c = !1),
            ...
            y = s ? "left" : "top",
            A = n.pag_clone,
            b = 1e3 * F(x = null, G(n, "pag_delay", .1)),
            l && (b = 10),
            k = function() {
                f = rt(P, n.pag_t),
                w = Math.floor(f["ps" + _] / f.p[_] + .1),
                p = V(P, n.pag_t),
                h = V(P, n.pag_i);
                var t, e = v ? w : p.length;
                Y.inf && e--,
                A && (null === x && (x = h[0].outerHTML),
                e < (t = h.length) ? gsap.set(Q(h, e, t), {
                    pgDom: {
                        remove: !0
                    }
                }) : t < e && gsap.set(h[0], {
            ...
            O = function(e) {
                ...
                m = m || setTimeout(function() {
                    ...
                    m = null,
                    C && (t = rt(P, n.pag_t, !0),
                    t = v ? Math.floor(t["sp" + y] / t.p[_] + .1) : H(f, null, s, "c", !0, null, e).idx,
                    Y.inf && t >= (v ? w - 1 : h.length) && (t = 0),
                    t = h[t],
                    g != t && (n.pag_pd && g && X.play(g, n.pag_pd),
            ...
            var E = function(t) {
                var e;
                (t = this.pgPinScrollTrigger || this.scrollTrigger) && (0 !== (e = t.getVelocity()) && (T = e),
                Y.seek(this.progress(), t.direction, 0),
                S && (t = this.progress(),
                Z.updateProgress(S, t, t)))
            };
            t.pin ? (B = gsap.timeline({
                scrollTrigger: t,
                onUpdate: function() {
            ...
            B.to({}, 100, {}, 0),
            I.pause(),
            gsap.globalTimeline.add(I)) : (I = gsap.timeline({
                scrollTrigger: t,
                onUpdate: E
            }),
            C = I.scrollTrigger),
                ...
                for (var L = 0; L < M.length; L++)
                    !function(s) {
                        ...
                        j(s) ? N.push({
                            ...
                            var t, e, a, n, i, o = V(P, s.t), r = tt(s.a, o);
                            return s.name && K(s.name, s.a),
                            r && (e = -1,
                            a = !(t = 0),
                            n = 0,
                            r._pg_animation_id = R ? Z.getAnimationId([P], "scene_item_" + L) : null,
                            "scroll" === G(s, "p", "scroll") ? (t = parseFloat(G(s, "s", 0)),
                            n = parseFloat(G(s, "sc_d", 100 - t)),
                            r.duration(n),
                            I.add(r, t),
                            r.play()) : (r.pause(),
                            null !== (i = G(s, "t_d", null)) && r.duration(parseFloat(i)),
                            t = parseFloat(G(s, "s", 0)) / 100,
                            i = G(s, "sc_dir", "down"),
                            e = s.rev ? "down" === i ? Math.min(.9, t + .5) : Math.max(0, t - .5) : -1,
                            a = !1,
                            l && .01 < r.duration() && r.duration(.01)),
                            i = {
                                start: t,
                                duration: n,
                                tl: r,
                            ...
                            N.push(i),
                            R && r.eventCallback("onUpdate", function() {
                                Z.updateProgress(this._pg_animation_id, this.time(), this.progress())
                            })),
                            i
                        }
                        ,
                        (t = W(s)) && !e ? D.add(t, function(t) {
                            var e = a();
                            return function() {
                                var t;
        ...
        this.seek = function(i, t, o) {
            ...
            n || (N.forEach(function(t) {
                t.detached && !t.disabled && (t.tl.duration(t.duration),
                I.add(t.tl, t.start),
                t.tl.play(),
                t.detached = !1)
            }),
            i = Math.round(100 * i) / 100,
            "down" == (r = -1 === t ? "up" : "down") && (i < s || 0 == s) && (s = -.1),
            "up" == r && s < i && (s = 1.1),
            N.forEach(function(t) {
                var e, a, n;
                t.disabled || (e = t.rep ? 0 : void 0,
                n = t.tl.progress(),
                a = Math.max(o, t.start),
                n = t.inv && (0 === n || 0 === e),
                t.scroll || ("down" == r ? 0 <= t.dir.indexOf("down") ? (s < a && a <= i && !L(t.tl) || a <= i && t.tl.reversed()) && (n && t.tl.invalidate(),
                t.rec && t.rec(t),
                t.tl.play(e),
                0 <= t.reverse_at && (t.reverse_at = i)) : 0 <= t.reverse_at && t.reverse_at <= i && !t.tl.reversed() && (t.rec && t.rec(t),
                t.tl.reverse()) : 0 <= t.dir.indexOf("up") ? (a < s && i <= a && !L(t.tl) || i <= a && t.tl.reversed()) && (n && t.tl.invalidate(),
                t.rec && t.rec(t),
                t.tl.play(e),
                0 <= t.reverse_at && (t.reverse_at = i)) : 0 <= t.reverse_at && t.reverse_at >= i && !t.tl.reversed() && (t.rec && t.rec(t),
                t.tl.reverse())))
        ...
        this.seekAnimation = function(t, e, a) {
            for (var n = 0; n < N.length; n++)
                if (N[n].animation_idx === t && !N[n].disabled) {
                    var i = N[n].tl
                      , o = Math.max(0, F(i, e));
                    N[n].scroll && a && !N[n].detached && (I.remove(i),
            ...
            for (var e = !1, a = 0; a < N.length; a++)
                if (N[a].animation_idx === t && !N[a].disabled)
                    try {
                        e = !0;
                        var n = N[a].tl.time()
                          , i = (i = JSON.parse(S(P.getAttribute("data-pg-ia-scene")))).l[a]
                          , o = V(P, i.t)
                          , r = tt(i.a, o);
                        i.name && K(i.name, i.a),
                        "scroll" === G(i, "p", "scroll") ? (N[a].detached = !1,
                        r.duration(N[a].duration),
                        I.add(r, N[a].start),
                        r.play()) : r.pause(Math.min(n, r.duration())),
                        N[a].tl.pause(0),
                        N[a].tl.kill(),
                        N[a].tl = r,
                        N[a].elements = o,
                        R && (r._pg_animation_id = Z.getAnimationId([P], "scene_item_" + t),
    ...
    X.scrollSceneManager = new function() {
        ...
        function a(t, e) {
            if (o(t),
            !t.hasAttribute("data-pg-ia-scene"))
                return null;
            t._pg_scroll_scene = new O(t),
    ...
    ,
    T = function(e, t) {
        var a, n, i = !1, o = null, r = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame, t = {
            slow: 10,
            normal: 30,
            fast: 60
        }[t.spd || "normal"];
        "HTML" === e.nodeName || "BODY" === e.nodeName ? (i = !0,
        ScrollTrigger.normalizeScroll({
            type: "touch,wheel",
            wheelSpeed: t / 30,
            scrollSpeed: t / 30,
            ignore: document.querySelectorAll("[data-pg-ia-smooth-scroll]:not(html)")
        })) : (a = e.scrollTop,
        n = function() {
            0;
            var t = 0 < (t = (a - e.scrollTop) / 6) ? Math.ceil(t) : Math.floor(t);
            e.scrollTop += t,
            .5 < Math.abs(t) && r && r(n)
        }
        ,
    ...
    X.smoothScrollManager = new function() {
        this.init = function() {
            $(document.querySelectorAll("[data-pg-ia-smooth-scroll]"), function(t) {
                e(t)
            })
        }
        ,
        this.refresh = function(t) {
            t._pg_smooth_scroll && (t._pg_smooth_scroll.destroy(),
            t._pg_smooth_scroll = null),
            e(t)
        }
        ;
        var e = function(t) {
            try {
                var e;
                t.hasAttribute("data-pg-ia-smooth-scroll") && (e = JSON.parse(S(t.getAttribute("data-pg-ia-smooth-scroll") || "{}")),
    ...
    ,
    X.smoothScrollManager.init()) : console && console.log("Pinegrow Interactions are not supported.")
}();
